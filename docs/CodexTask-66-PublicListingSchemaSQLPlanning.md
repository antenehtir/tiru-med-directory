# Codex Task 66: Public Listing Schema SQL Planning
...
Create a documentation-only SQL/schema planning document for the first Supabase public listing tables, starting with facilities and supporting public directory read requirements.

This task is documentation-only.

Do not create Supabase tables.

Do not add SQL files.
