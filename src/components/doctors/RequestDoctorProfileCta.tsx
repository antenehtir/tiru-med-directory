...
export function RequestDoctorProfileCta() {
  return (
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
        <div>
          <p className="text-sm font-semibold uppercase tracking-normal">
            Doctor profile addition
          </p>
          <h2 className="mt-2 text-2xl font-semibold leading-tight">
            Want a doctor profile to appear here?
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-primary-foreground/85">
            This prepares the future doctor profile request flow without forms,
            booking, authentication, uploads, or database logic.
          </p>
        </div>
        <Link
