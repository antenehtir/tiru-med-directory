    ...
    <div aria-label="Healthcare categories">
      ...
      <div className="flex max-w-full flex-wrap items-center justify-center gap-2 sm:justify-start">
        {healthcareCategories.map((category, index) => (
          <Link
            key={category}
            className={`inline-flex min-h-11 max-w-full items-center justify-center rounded-full border px-4 py-2.5 text-center text-sm font-semibold leading-tight transition sm:px-5 ${
              index === 0
